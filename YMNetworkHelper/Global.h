...
//设备类型
#define kIsIphone6Plusor6sPlus (kWindowHeight == 736)   //414
#define kIsIphone6or6s (kWindowHeight == 667)   //375
 ...
 */
// 宏定义之后的用法
//BLOCK_EXISTCALL(completionBlock, arg1, arg2);
#define BLOCK_EXISTCALL(block, ...) if (block) { block(__VA_ARGS__); };
